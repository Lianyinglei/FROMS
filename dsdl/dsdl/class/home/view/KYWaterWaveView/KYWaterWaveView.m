...
- (CAGradientLayer *)gradientLayer {
      if (!_gradientLayer) {
            ...
            _gradientLayer.colors = @[(id)kUIColorFromRGB(0x999999).CGColor,
                                      (id)kUIColorFromRGB(0xeeeeee).CGColor,(id)kUIColorFromRGB(0xe1e1e1).CGColor];
            [_gradientLayer setStartPoint:CGPointMake(0.5, 0.1)];
            [_gradientLayer setEndPoint:CGPointMake(0.3, 0.9)];
            
            [_gradientLayer setMask:_waveLayer];
