...
#define kArrowSize      8.0f   //!< 箭头尺寸
#define kCornerRadius   3.0f    //!< 圆角
...
//    const CGFloat kMinMenuItemWidth = 32.f;
    const CGFloat kMinMenuItemHeight = 49.f;
    const CGFloat kMinMenuItemWidth = 150.f;
    
    const CGFloat kMarginX = 10.f;
//    const CGFloat kMarginY = 5.f;//取消外边框
